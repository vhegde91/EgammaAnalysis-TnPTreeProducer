...
config.JobType.psetName  = '/afs/cern.ch/work/v/vhegde/public/EGamma_v3/withSUSYids_v1/CMSSW_9_4_0_pre3/src/EgammaAnalysis/TnPTreeProducer/python/TnPTreeProducer_cfg.py'
